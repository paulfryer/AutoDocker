...
{
    public AutoDockerBuildStack(string account, string solutionName, List<string> projectNames, App scope, string id,
        IStackProps? props = null) : base(scope, id, props)
    {
        ...
        */
        ...
        var buildStage = new StageProps
        {
            StageName = "BuildStage"
        };

        var buildStageActions = new List<IAction>();
        foreach (var project in projectNames)
            buildStageActions.Add(
                new CodeBuildAction(new CodeBuildActionProps
                {
                    ...
                    {
                        {
                            "ACCOUNT", new BuildEnvironmentVariable
                            {
                        ...
                        {
                            "REPO_NAME", new BuildEnvironmentVariable
                            {
                                Type = BuildEnvironmentVariableType.PLAINTEXT,
                        ...
                        {
                            "PROJECT_NAME", new BuildEnvironmentVariable
                            {
                                Type = BuildEnvironmentVariableType.PLAINTEXT,
                                Value = project
                            }
